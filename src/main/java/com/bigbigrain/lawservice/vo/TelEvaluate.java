 ...
 *
 */
public class TelEvaluate {
	/**唯一编码*/
	private String wybm;
	
	/**来电时间*/
	private Date ld_time;
	...
	public Date getLd_time() {
		return ld_time;
	}

	public void setLd_time(Date ld_time) {
		this.ld_time = ld_time;
	}
	...
	public String toString() {
		return "TelEvaluate [wybm=" + wybm + ", ld_time=" + ld_time + ", department=" + department + ", xzqh_name="
				+ xzqh_name + ", xzqh=" + xzqh + ", service_type=" + service_type + ", overall_evaluate="
				+ overall_evaluate + ", pj_time=" + pj_time + ", flag=" + flag + ", create_name=" + create_name
				+ ", create_time=" + create_time + ", update_name=" + update_name + ", update_time=" + update_time
